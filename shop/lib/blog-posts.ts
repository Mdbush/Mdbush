...
export const posts: BlogPost[] = [
  ...
  {
    slug: "how-to-raise-rates-existing-clients-uae",
    title: "How to Raise Your Freelance Rates With Existing Clients in the UAE",
    description:
      "Word-for-word email templates, the right timing, and the 3-step conversation framework that lets you raise rates without losing the client.",
    date: "June 16, 2026",
    readTime: "7 min read",
    category: "Business",
  },
  {
    slug: "freelance-work-life-balance-uae",
    title: "Work-Life Balance for UAE Freelancers: How to Protect Your Time Without Losing Clients",
    description:
      "Why UAE freelancers answer WhatsApp at 11pm — and the 3 boundaries, shutdown ritual, and client re-training system that actually fixes it.",
    date: "June 16, 2026",
    readTime: "6 min read",
    category: "Business",
  },
