      ...
      <main className="min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-4 py-10">
          ...
          <div className="rounded-2xl mb-8 overflow-hidden">
            <div className="bg-gradient-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] px-6 py-8">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <p className="text-pink-100 text-xs font-bold uppercase tracking-widest mb-1">Visual-first · Reels dominate · Carousels save</p>
                  <h1 className="text-3xl sm:text-4xl font-bold text-white leading-tight">Instagram Content Library</h1>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 bg-gradient-to-r from-[#6B2D9E] to-[#B5245A]">
              {[
                { value: "3×", label: "Reels (reach)" },
                { value: "2×", label: "Carousels (saves)" },
                { value: "Daily", label: "Stories (presence)" },
                { value: "7–9 AM", label: "best time UAE" },
              ].map(({ value, label }) => (
                <div key={label} className="px-4 py-4 text-center border-r border-purple-700 last:border-0">
                  <p className="text-base font-bold text-white">{value}</p>
                  <p className="text-xs text-pink-200 mt-0.5 leading-tight">{label}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            {reels.map((r) => (
              <div key={r.id} className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100 flex items-start gap-3">
                  <span className="w-8 h-8 bg-[#E1306C] text-white rounded-full flex items-center justify-center shrink-0 font-bold text-sm">
                    {r.id}
                  </span>
