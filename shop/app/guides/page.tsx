...
export const metadata: Metadata = {
  ...
  description:
    "400+ practical guides for freelancers and solopreneurs across the UAE, Saudi Arabia, and GCC. Visa, tax, rates, clients, contracts, AI tools, and more. All free.",
  alternates: { canonical: "/guides" },
  openGraph: {
    title: "UAE & GCC Freelancer Guides & Resources — SoloKit",
    description: "400+ free guides covering everything a UAE and GCC freelancer needs to know.",
    type: "website",
    url: "/guides",
  },
};
...
const categories = [
  ...
  },
  {
    ...
    guides: [
      ...
      { slug: "how-to-find-first-freelance-client-uae", title: "How to Find Your First Freelance Client in the UAE (2026 Guide)", time: "8 min" },
    ],
  },
  {
    name: "Pricing & Rates",
    ...
    guides: [
      ...
      { slug: "freelance-dietitian-rates-uae", title: "Freelance Dietitian & Nutritionist Rates in the UAE (2026)", time: "7 min" },
      ...
      { slug: "freelance-audiologist-rates-uae", title: "Freelance Audiologist Rates in the UAE (2026): What to Charge", time: "7 min" },
      { slug: "freelance-bookkeeper-rates-uae", title: "Freelance Bookkeeper Rates in the UAE (2026): What to Charge", time: "7 min" },
      { slug: "freelance-ecommerce-consultant-rates-uae", title: "Freelance Ecommerce Consultant Rates in the UAE (2026): What to Charge", time: "7 min" },
      { slug: "freelance-risk-manager-rates-uae", title: "Freelance Risk Manager Rates in the UAE (2026): What to Charge", time: "9 min" },
    ],
  },
  {
  ...
  },
  {
    ...
    guides: [
      ...
      { slug: "how-to-build-passive-income-uae", title: "How to Build Passive Income as a UAE Freelancer (2026): 5 Real Streams", time: "10 min" },
    ],
  },
  {
    name: "Getting Started",
    description: "Launch your UAE freelance business properly — licence, banking, and first steps.",
    guides: [
    ...
    <>
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="relative isolate overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 text-white px-6 py-12 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">The UAE Freelancer <span className="text-gradient">Playbook</span></h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">
            400+ practical guides covering everything you need to know about freelancing in the UAE, Saudi Arabia, and across the GCC.
