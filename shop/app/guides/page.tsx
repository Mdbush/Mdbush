...
export const metadata: Metadata = {
  ...
  description:
    "113 practical guides for freelancers and solopreneurs in the UAE. Visa, tax, rates, clients, contracts, AI tools, and more. All free.",
  alternates: { canonical: "/guides" },
  openGraph: {
    title: "UAE Freelancer Guides & Resources — SoloKit",
    description: "113 free guides covering everything a UAE freelancer needs to know.",
    type: "website",
    url: "/guides",
  },
};
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto leading-relaxed">
            113 practical guides covering everything you need to know about freelancing in Dubai and Abu Dhabi.
