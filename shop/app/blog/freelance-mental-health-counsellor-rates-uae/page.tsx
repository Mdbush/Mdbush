        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Mental health counselling and psychotherapy is one of the most
              rapidly expanding allied health sectors in the UAE — driven by
              growing mental health awareness across the expat and increasingly
              the Emirati population, the challenging adjustment experiences
              of a highly mobile international workforce, the particular mental
              health pressures of the UAE&apos;s high-intensity working culture,
              and a significant normalisation of help-seeking behaviour that
              has accelerated since the COVID-19 period. The UAE has made
              notable investments in mental health infrastructure (DHA Mental
              Health Strategy, Abu Dhabi Mental Health Strategy 2020) and
              the licensing framework for mental health professionals has
              matured significantly. Practice licensing in the UAE distinguishes
              between licensed counsellors (typically holding a masters-level
              counselling qualification with professional body registration —
              BACP, UKCP, or equivalent), licensed psychotherapists (advanced
              modality training including CBT, EMDR, psychodynamic), and
              licensed clinical psychologists (doctoral level). DHA or DOH
              registration is required for clinical practice — with scope of
              practice linked to your qualification level. Freelance mental
              health practitioners in the UAE work across private clinic
              settings, telehealth platforms, school contracts, and corporate
              EAP (Employee Assistance Programme) provision.
            </p>
