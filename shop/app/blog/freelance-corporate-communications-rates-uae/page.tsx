        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Corporate communications — distinct from PR and marketing — covers how organisations
              communicate with employees, executives, investors, boards, and key stakeholders.
              In the UAE, the demand for freelance corporate communications consultants comes from
              several sources: large transformation programmes (ERP implementations, restructures,
              leadership transitions), UAE banks and financial institutions requiring investor
              communications and annual report writing, government entities managing public
              communications around major initiatives, and multinationals based in DIFC or
              Abu Dhabi needing regional communications support. Crisis communications specialists
              earn the highest rates in the segment — the need is urgent, the stakes are high,
              and the expertise is scarce.
            </p>
