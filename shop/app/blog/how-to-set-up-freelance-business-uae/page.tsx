    ...
    <>
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex gap-2 flex-wrap">
          ...
          <span>›</span>
          <span className="text-gray-600">Set Up Freelance Business UAE</span>
        </nav>

        <header className="mb-8">
          <span className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Getting Started</span>
          ...
          <p className="text-gray-500 text-sm">June 16, 2026 · 10 min read</p>
        </header>
