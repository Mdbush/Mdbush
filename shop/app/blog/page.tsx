...
export const metadata: Metadata = {
  ...
  description: "83 free guides for freelancers and solopreneurs in the UAE. Visa, tax, rates, proposals, AI tools, contracts, and more. No fluff.",
  alternates: { canonical: "/blog" },
  openGraph: {
    title: "Free Guides for UAE Freelancers — SoloKit Blog",
    description: "83 practical guides covering everything UAE freelancers need. No fluff.",
    url: "/blog",
    type: "website",
  },
};
