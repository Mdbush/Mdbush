    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-10">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex items-center gap-1.5">
          ...
          <span>/</span>
          <span className="text-gray-600">Freelance Fashion Stylist Rates in the UAE (2026): What</span>
        </nav>
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 py-10 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">Freelance Fashion Stylist Rates in the UAE (2026): What to Charge</h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">Real AED rates for freelance fashion stylists in Dubai and Abu Dhabi — editorial, personal styling, commercial shoots, and event dressing for 2026.</p>
