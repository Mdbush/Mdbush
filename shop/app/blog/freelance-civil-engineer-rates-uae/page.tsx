    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 py-10 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">Freelance Civil Engineer Rates in the UAE (2026)</h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">Real AED day rates for freelance civil engineers in Dubai and Abu Dhabi. Structural design, infrastructure advisory, roads and highways, geotechnical consulting, project management, and construction supervision fees for 2026.</p>
