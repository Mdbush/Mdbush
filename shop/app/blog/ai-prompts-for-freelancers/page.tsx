    ...
    <>
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 py-10 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">How to Use AI to Do More Freelance Work in Less Time</h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">The exact AI prompts I use for client proposals, follow-up emails, content creation, and more — plus the mistakes that waste your time with ChatGPT and Claude.</p>
