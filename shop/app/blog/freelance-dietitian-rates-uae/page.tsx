        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight">
              Freelance Dietitian & Nutritionist Rates in the UAE (2026)
            </h1>
            <p className="text-lg text-gray-600 mb-4">
              Dietetics and nutrition practice in the UAE spans a broad
              spectrum — from registered dietitians (RDs) providing medical
              nutrition therapy for diabetes, renal disease, oncology, and
              clinical conditions in hospital outpatient and clinic settings,
              to nutritionists providing weight management, sports nutrition,
              and wellness counselling in private practice and corporate
              wellness settings. The UAE distinction matters for practice scope:
              Registered Dietitians (holding a recognised RD credential —
              UK RD via BDA/HCPC, Australian APD, Canadian RD, American RD/RDN)
              are licensed by DHA (Dubai) or DOH (Abu Dhabi) for clinical
              nutrition practice, including medical nutrition therapy for
              specific conditions. Non-credentialed nutritionists operate in
              a less regulated space focused on wellness and lifestyle nutrition.
              The UAE market is large and growing: high rates of obesity, type
              2 diabetes, and metabolic syndrome in both the Emirati and expat
              populations drive clinical dietetics demand; the active lifestyle
              and fitness-focused expat community drives sports nutrition
              demand; and corporate employers increasingly invest in workplace
              wellness programmes that include nutrition components.
            </p>
