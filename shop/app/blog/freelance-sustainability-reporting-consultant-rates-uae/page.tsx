        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Sustainability reporting — advising companies on ESG (Environmental, Social, and
              Governance) disclosures, climate risk reporting, and non-financial reporting
              frameworks — has become a mainstream professional services discipline in the UAE
              as regulators, investors, and supply chain partners demand credible sustainability
              data. The Securities and Commodities Authority (SCA), Dubai Financial Market (DFM),
              and Abu Dhabi Securities Exchange (ADX) have all introduced mandatory ESG
              disclosure requirements for listed companies, and the UAE Net Zero 2050 strategy
              has driven reporting obligations across government-linked entities and large
              corporations. This regulatory push creates consistent demand for experienced
              sustainability reporting consultants who combine technical knowledge of reporting
              frameworks (GRI, TCFD, ISSB) with an understanding of the UAE regulatory
              context and Arabic-language reporting requirements.
            </p>
