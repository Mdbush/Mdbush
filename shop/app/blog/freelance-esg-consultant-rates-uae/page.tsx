        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-600 mb-4">
              The UAE has made Environmental, Social, and Governance (ESG) and sustainability
              a national strategic priority — committing to net zero emissions by 2050,
              hosting COP28 in Dubai in 2023, and establishing the UAE Sustainable Finance
              Working Group to align capital markets with sustainability objectives. The
              Securities and Commodities Authority (SCA) and Dubai Financial Services
              Authority (DFSA) are implementing mandatory ESG disclosure requirements for
              listed companies, while Abu Dhabi Global Market (ADGM) has established a
              sustainable finance regulatory framework. Beyond regulation, UAE sovereign
              wealth funds (Mubadala, ADQ, ADIA) are integrating ESG criteria into
              investment decisions, and major UAE banks (FAB, ENBD, ADCB) are competing
              to lead green and sustainability-linked lending. This regulatory and capital
              market momentum is creating sustained demand for freelance ESG consultants
              across strategy, reporting, carbon, and green finance disciplines.
            </p>
