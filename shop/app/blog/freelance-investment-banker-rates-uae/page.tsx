    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="relative isolate overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 text-white px-6 py-12 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">Freelance Investment Banker & M&A Advisor Rates in the UAE (2026)</h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">Real AED rates for freelance investment bankers and M&A advisors in Dubai and Abu Dhabi. Buy-side and sell-side M&A advisory, capital raising, financial modelling, pitch deck preparation, due diligence, and success fee structures for 2026.</p>
