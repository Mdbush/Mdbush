    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 py-10 rounded-2xl mb-8">
          ...
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">Practical guide to building passive income streams as a UAE-based freelancer — digital products, Notion templates, SEO content, affiliate income, licensing your expertise, and rental income context. Realistic AED numbers, timelines, and UAE-specific advice.</p>
