    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 py-10 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">How to Subcontract Freelance Work in the UAE (2026 Guide)</h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">How UAE freelancers build a subcontracting network to take on larger projects, handle overflow, and scale without going agency. Finding subcontractors, setting rates, contracts, quality control, and client communication.</p>
