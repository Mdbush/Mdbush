        ...
        <div className="text-gray-700 leading-relaxed space-y-6">
          ...
          <div className="mt-10 pt-6 border-t border-gray-100">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/affiliates" className="text-sm text-gray-500 hover:text-gray-900 transition-colors underline underline-offset-2">
                SoloKit Affiliate Program — Earn 30% Per Sale →
              </Link>
              <Link href="/products/ai-prompt-pack-pro" className="text-sm text-gray-500 hover:text-gray-900 transition-colors underline underline-offset-2">
