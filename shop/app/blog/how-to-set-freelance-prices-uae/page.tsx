    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex items-center gap-1.5">
          ...
          <span>/</span>
          <span className="text-gray-600">How to Set Your Freelance Prices in the UAE: The Comple</span>
        </nav>
        ...
        <div className="relative isolate overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 text-white px-6 py-12 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">How to Set Your Freelance Prices in the UAE: The Complete System (2026)</h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">A step-by-step pricing system for UAE freelancers — how to calculate your minimum viable rate, what your UAE market actually pays, when to raise prices, and how to present your rates to clients without losing the deal.</p>
