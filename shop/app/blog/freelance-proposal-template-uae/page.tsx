    ...
    <>
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 py-10 rounded-2xl mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-4">Freelance Proposal Template UAE (Copy-Paste Ready for Dubai Clients)</h1>
          <p className="text-gray-300 text-sm mb-5 leading-relaxed max-w-xl">A complete copy-paste freelance proposal template for UAE clients, plus the structure, common mistakes, and AI prompts to write winning proposals in 20 minutes.</p>
        ...
        <div className="space-y-6 leading-relaxed">
          ...
          <div className="relative my-6">
            <pre className="bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100 rounded-2xl p-5 text-sm leading-relaxed overflow-x-auto whitespace-pre font-mono select-all">
              {proposalTemplate}
            </pre>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl p-6 mt-6">
