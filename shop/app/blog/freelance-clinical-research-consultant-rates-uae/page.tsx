        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Clinical research — the design, management, and regulatory submission of
              clinical trials, pharmacovigilance programmes, and medical device studies —
              is a specialist discipline in growing demand in the UAE. The UAE has prioritised
              becoming a regional hub for pharmaceutical innovation and clinical research:
              the Dubai Science Park (DSP), Abu Dhabi&apos;s pharmaceutical manufacturing
              cluster, and increasing clinical trial activity at UAE academic medical centres
              (Cleveland Clinic Abu Dhabi, Mediclinic Hospitals, Sheikh Khalifa Medical City)
              create demand for experienced clinical research professionals. Pharmaceutical
              companies expanding into MENA markets also require UAE regulatory expertise
              (MOHAP, DHA, and DOH registration submissions) that can only come from
              consultants with UAE-specific regulatory experience.
            </p>
